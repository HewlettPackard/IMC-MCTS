...
"""
Accelerator 13x13 Event-Driven Hardware Analysis
==================================================================
...
Usage:
    python run_13x13_hardware_metrics.py [low|medium|high]
"""
...
def create_simulation(board_size: int, performance_level: PerformanceLevel):
    """Override to use 13x13 board"""
    return _original_create_simulation(13, performance_level)

def main():
    """Run the SST simulation with hardware performance analysis for 13x13"""
    parser = argparse.ArgumentParser(
        description='Accelerator 13x13 MCTS with Event-Driven Hardware Analysis',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Performance Levels:
  low     - Fast search, 1000 iterations
  medium  - Balanced, 7500 iterations (default)
  high    - Strong play, 75000 iterations
...
This uses:
  ...
  - hardware metrics model for area, power, energy, throughput analysis
    ...
    print("="*80)
    print("Accelerator 13x13 MCTS - Event-Driven Hardware Analysis")
    print("="*80)
    print()
    ...
    performance_config = get_performance_config(13, performance_level)
    ...
    hardware_model = HardwareModel(board_size=13)
