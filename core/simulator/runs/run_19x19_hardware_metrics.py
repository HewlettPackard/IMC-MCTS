...
"""
Accelerator 19x19 Event-Driven Hardware Analysis
==================================================================
...
Usage:
    python run_19x19_hardware_metrics.py [low|medium|high]
"""
...
def create_simulation(board_size: int, performance_level: PerformanceLevel):
    """Override to use 19x19 board"""
    return _original_create_simulation(19, performance_level)

def main():
    """Run the SST simulation with hardware performance analysis for 19x19"""
    parser = argparse.ArgumentParser(
        description='Accelerator 19x19 MCTS with Event-Driven Hardware Analysis',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Performance Levels:
  low     - Fast search, 2000 iterations
  medium  - Balanced, 15000 iterations (default)
  high    - Strong play, 150000 iterations
...
This uses:
  ...
  - hardware metrics model for area, power, energy, throughput analysis
    ...
    print("="*80)
    print("Accelerator 19x19 MCTS - Event-Driven Hardware Analysis")
    print("="*80)
    print()
    ...
    performance_config = get_performance_config(19, performance_level)
    ...
    hardware_model = HardwareModel(board_size=19)
