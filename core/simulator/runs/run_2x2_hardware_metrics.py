...
"""
Accelerator 2x2 Event-Driven Hardware Analysis
==================================================================
...
Usage:
    python run_2x2_hardware_metrics.py [low|medium|high]
"""
...
def create_simulation(board_size: int, performance_level: PerformanceLevel):
    """Override to use 2x2 board"""
    return _original_create_simulation(2, performance_level)

def main():
    """Run the SST simulation with hardware performance analysis for 2x2"""
    parser = argparse.ArgumentParser(
        description='Accelerator 2x2 MCTS with Event-Driven Hardware Analysis',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Performance Levels:
  low     - Fast search, 25 iterations
  medium  - Balanced, 250 iterations (default)
  high    - Strong play, 2500 iterations
...
This uses:
  ...
  - hardware metrics model for area, power, energy, throughput analysis
    ...
    print("="*80)
    print("Accelerator 2x2 MCTS - Event-Driven Hardware Analysis")
    print("="*80)
    print()
    ...
    performance_config = get_performance_config(2, performance_level)
    ...
    hardware_model = HardwareModel(board_size=2)
