...
"""
Accelerator 9x9 Event-Driven Hardware Analysis
==================================================================
...
Usage:
    python run_9x9_hardware_metrics.py [low|medium|high]
"""
...
def create_simulation(board_size: int, performance_level: PerformanceLevel):
    """Override to use 9x9 board"""
    return _original_create_simulation(9, performance_level)

def main():
    """Run the SST simulation with hardware performance analysis for 9x9"""
    parser = argparse.ArgumentParser(
        description='Accelerator 9x9 MCTS with Event-Driven Hardware Analysis',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Performance Levels:
  low     - Fast search, 500 iterations
  medium  - Balanced, 5000 iterations (default)
  high    - Strong play, 50000 iterations
...
This uses:
  ...
  - hardware metrics model for area, power, energy, throughput analysis
    ...
    print("="*80)
    print("Accelerator 9x9 MCTS - Event-Driven Hardware Analysis")
    print("="*80)
    print()
    ...
    performance_config = get_performance_config(9, performance_level)
    ...
    hardware_model = HardwareModel(board_size=9)
