...
- Timestamp, anonymized system ID, processor info
...
- Remote GPU setup: `docs/QUICKSTART_GPU_REMOTE.md`
- Generated benchmark results are local-only and excluded from the source release.
